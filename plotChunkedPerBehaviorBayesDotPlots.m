...
for a = 1:numel(uniqueAnimals)
    ...
    for bIdx = 1:nBeh
        ...
        % Print exact Bayes-factor value above each dot.
        if isfinite(thisBFPlus)
            text(1,thisBFPlus,sprintf('%.3f',thisBFPlus), ...
        ...
        if isfinite(thisBFMinus)
            text(2,thisBFMinus,sprintf('%.3f',thisBFMinus), ...
                'HorizontalAlignment','center', ...
                'VerticalAlignment','bottom', ...
                'FontSize',10, ...
                'FontWeight','bold');
